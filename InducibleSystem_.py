...
class InducibleSystem:
    ...
    def RunModels(self, iteration = 1):
        ...
        for loop in range(0, iteration):
            ...
            self.Model_List.append('Model 1 - ConstantInducer')
    ...
    def PlotSBOLGraphics(self):
        ...
        if PlotCircuitFile == 'yes':
            ...
            if PlasmidNum == '1':
                if PartNum == '1':
                    Input = "p.black.pLac r.black c." + ReporterColor + Reporter+ " " + "t.black o.black." + Origin[0]
                    ...
                    print('Error: The number of part and plasmid is not compatible')
    ...
    def AutoRunInducibleSystem(self, Input_filename, NumDataSet, Inducer_unit, OptInhibition):
